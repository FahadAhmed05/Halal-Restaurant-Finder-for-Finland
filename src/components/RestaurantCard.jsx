        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <Link
              ...
              className="flex items-center justify-start gap-1 truncate text-[1.08rem] font-semibold text-slate-900 transition hover:text-emerald-800"
            >
              {restaurant.name}
          ...
          <span className="rating-badge">{restaurant.badgeText}</span>
        </div>
